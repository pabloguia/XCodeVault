...
final class CatalogTests: XCTestCase {
    ...
    func testNoCategoryMayRelocateForbiddenPaths() {
        let bad = StorageCategory(
            id: "bad", name: "bad", subsystem: .coreSimulator,
    ...
    func testSystemPathsAreAppleManagedOnly() {
        let bad = StorageCategory(
            id: "sys", name: "sys", subsystem: .mobileAsset,
    ...
    func testNonRegenerableCannotBeSafeCleanup() {
        let bad = StorageCategory(
            id: "arch", name: "arch", subsystem: .xcodeIDE,
    ...
    func testExperimentalLabelingFollowsEvidence() {
        let noEvidence = StorageCategory(
            id: "a", name: "a", subsystem: .other, pathTemplates: ["/tmp/a"], description: "",
            regenerability: .regenerable, deletionRisk: .low, relocationRisk: .low,
        ...
        let verified = StorageCategory(
            id: "b", name: "b", subsystem: .other, pathTemplates: ["/tmp/b"], description: "",
            regenerability: .regenerable, deletionRisk: .low, relocationRisk: .low,
